...
$query5="SELECT COUNT(id) FROM `customer_details` WHERE city='Windsor'";
$res5=mysqli_query($conn,$query5);
$row5=mysqli_fetch_array($res5);
$windsor_orders=$row5[0];

$query6="SELECT COUNT(id) FROM `customer_details` WHERE city='Brampton'";
$res6=mysqli_query($conn,$query6);
$row6=mysqli_fetch_array($res6);
$brampton_orders=$row6[0];

$query7="SELECT COUNT(id) FROM `customer_details` WHERE city='London'";
$res7=mysqli_query($conn,$query7);
$row7=mysqli_fetch_array($res7);
$london_orders=$row7[0];

$query8="SELECT COUNT(id) FROM `customer_details` WHERE city='Chatham'";
$res8=mysqli_query($conn,$query8);
$row8=mysqli_fetch_array($res8);
$chatham_orders=$row8[0];
                    ...
                    <div class="demo-options mdl-card mdl-color--blue-300 mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--3-col-tablet mdl-cell--12-col-desktop">
                        <div class="mdl-card__supporting-text mdl-color-text--blue-grey-50">
                            ...
                            <marquee direction="up" scrollamount="1">
                                <li>You have <b><?php echo $windsor_orders?> orders</b> from <b>Windsor</b></li>
                                <li>You have <b><?php echo $brampton_orders?> orders</b> from <b>Brampton</b></li>
                                <li>You have <b><?php echo $cambridge_orders?> orders</b> from <b>Cambridge</b></li>
                                <li>You have <b><?php echo $london_orders?> orders</b> from <b>London</b></li>
